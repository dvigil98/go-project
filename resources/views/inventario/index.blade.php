                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if( $i->estado == 'Disponible' )
                                            <p class="font-weight-bold text-success">Disponible</p>
                                            @else
                                            <p class="font-weight-bold text-danger">No disponible</p>   
                                            @endif
                                        </td>
                                        <td class="w-25 text-center">
                                            <div class="btn-group">
                                                <a href="/inventarios/editar/{{ $i->id }}" class="btn btn-light" title="Editar"><i class="fas fa-pen-alt"></i></a>
                                                <!-- <a href="#" data-toggle="modal" data-target="#exampleModal{{ $i->id }}" class="btn btn-light" title="Eliminar"><i class="fas fa-trash"></i></a> -->
                                            </div>
                                            <form action="/inventarios/eliminar/{{ $i->id }}" method="post">
                                                @csrf
                                                @method('DELETE')
