        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <a href="/empresas/agregar" class="btn btn-primary">Agregar empresa</a>
                </div>
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-25 text-center">
                                            <div class="btn-group">
                                                <a href="/empresas/detalles/{{ $i->id }}" class="btn btn-light" title="Detalles"><i class="fas fa-info-circle"></i></a>
                                                <a href="/empresas/editar/{{ $i->id }}" class="btn btn-light" title="Editar"><i class="fas fa-pen-alt"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#exampleModal{{ $i->id }}" class="btn btn-light" title="Eliminar"><i class="fas fa-trash"></i></a>
                                            </div>
                                            <form action="/empresas/eliminar/{{ $i->id }}" method="post">
                                                @csrf
                                                @method('DELETE')
